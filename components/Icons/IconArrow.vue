<template>
    <div class="w-[22px] h-[22px] bg-[#FDC300] rounded-[6px] flex items-center justify-center">
        <svg @mouseenter="animateArrow" class="w-[12px] h-[13px]" viewBox="0 0 12 13" fill="none"
